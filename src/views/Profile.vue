<template>
  <div class="w-full h-full justify-between pb-20">
    <div class="">
      <BaseTopNav :title="$t('titles.profile')" />
      <div class="h-40 w-full relative">
        <div class="px-10 pt-5 flex flex-col items-center">
      ...
      <div class="flex flex-col px-10 mt-16">
        <div
          ...
          class="flex items-center justify-between cursor-pointer border-b border-b-white-20 dark:border-b-white-500 py-2.5"
